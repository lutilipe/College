...
// Saida: depende da operacao escolhida
{
  ...
  switch (opescolhida){
    case OPSOMAR:
	 ...
	 defineFaseMemLog(0);
         createMatrix(&a,optx,opty,0);
         initRandomMatrix(&a);
         createMatrix(&b,optx,opty,1);
         initRandomMatrix(&b);
         createMatrix(&c,optx,opty,2);
         initNullMatrix(&c);
	 defineFaseMemLog(1);
         accessMatrix(&a);
         accessMatrix(&b);
    ...
    case OPMULTIPLICAR:
	 ...
	 defineFaseMemLog(0);
         createMatrix(&a,optx,opty,0);
         initRandomMatrix(&a);
         createMatrix(&b,opty,optx,1);
         initRandomMatrix(&b);
         createMatrix(&c,optx,optx,2);
         initNullMatrix(&c);
	 defineFaseMemLog(1);
         accessMatrix(&a);
         accessMatrix(&b);
